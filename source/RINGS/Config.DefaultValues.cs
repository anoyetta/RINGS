    ...
    public partial class Config
    {
        ...
        private static ChatChannelSettingsModel[] CreateDefaultChatChannelsSettings()
        {
            var defaultSettings = new[]
            {
                ...
                new ChatChannelSettingsModel() { ChatCode = ChatCodes.CrossWorldLinkshell1, Color = WaColors.かんぞういろ, },
                new ChatChannelSettingsModel() { ChatCode = ChatCodes.CrossWorldLinkshell2, Color = WaColors.かんぞういろ, },
                new ChatChannelSettingsModel() { ChatCode = ChatCodes.CrossWorldLinkshell3, Color = WaColors.かんぞういろ, },
                new ChatChannelSettingsModel() { ChatCode = ChatCodes.CrossWorldLinkshell4, Color = WaColors.かんぞういろ, },
                new ChatChannelSettingsModel() { ChatCode = ChatCodes.CrossWorldLinkshell5, Color = WaColors.かんぞういろ, },
                new ChatChannelSettingsModel() { ChatCode = ChatCodes.CrossWorldLinkshell6, Color = WaColors.かんぞういろ, },
                new ChatChannelSettingsModel() { ChatCode = ChatCodes.CrossWorldLinkshell7, Color = WaColors.かんぞういろ, },
                new ChatChannelSettingsModel() { ChatCode = ChatCodes.CrossWorldLinkshell8, Color = WaColors.かんぞういろ, },
